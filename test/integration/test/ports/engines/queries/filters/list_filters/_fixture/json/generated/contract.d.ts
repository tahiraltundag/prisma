...
export type FieldOutputTypes = {
  readonly public: {
    readonly TestModel: {
      ...
      readonly json: ReadonlyArray<CodecTypes['pg/jsonb@1']['output']>;
    };
  };
};
export type FieldInputTypes = {
  readonly public: {
    readonly TestModel: {
      ...
      readonly json: ReadonlyArray<CodecTypes['pg/jsonb@1']['input']>;
    };
  };
};
...
export namespace Models {
  export type public_TestModel = {
    ...
    json: ReadonlyArray<CodecTypes['pg/jsonb@1']['output']>;
