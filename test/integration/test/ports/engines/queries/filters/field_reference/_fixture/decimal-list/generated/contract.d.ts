...
export type FieldOutputTypes = {
  readonly public: {
    readonly TestModel: {
      ...
      readonly dec_list: ReadonlyArray<CodecTypes['pg/numeric@1']['output']>;
      readonly dec_list2: ReadonlyArray<CodecTypes['pg/numeric@1']['output']>;
    };
  };
};
export type FieldInputTypes = {
  readonly public: {
    readonly TestModel: {
      ...
      readonly dec_list: ReadonlyArray<CodecTypes['pg/numeric@1']['input']>;
      readonly dec_list2: ReadonlyArray<CodecTypes['pg/numeric@1']['input']>;
    };
  };
};
          ...
          readonly TestModel: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly dec_list: { readonly column: 'dec_list' };
                readonly dec_list2: { readonly column: 'dec_list2' };
              };
            };
          };
        };
