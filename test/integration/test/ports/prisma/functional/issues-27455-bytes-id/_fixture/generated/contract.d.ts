        ...
        readonly entries: {
          readonly table: {
            ...
            readonly accommodationTimeTable: {
              ...
              indexes: readonly [
                {
                  readonly name: 'accommodationTimeTable_accommodationId_idx_6cccc5ae';
                  readonly prefix: 'accommodationTimeTable_accommodationId_idx';
                  readonly columns: readonly ['accommodationId'];
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    ...
                    readonly tableName: 'accommodationTimeTable';
                    readonly columns: readonly ['accommodationId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'accommodation';
...
> & {
  ...
  readonly roots: {
    ...
    readonly accommodationTimeTable: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'AccommodationTimeTable';
    };
  };
  readonly domain: {
    readonly namespaces: {
            ...
            readonly relations: {
              readonly timeTables: {
                ...
                readonly on: {
                  ...
                  readonly targetFields: readonly ['accommodationId'];
                };
              };
            };
            readonly storage: {
              readonly table: 'accommodation';
