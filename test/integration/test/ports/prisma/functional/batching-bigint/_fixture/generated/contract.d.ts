...
export type StorageHash =
  StorageHashBase<'d51f87f943fca86e9189c26629f5aeb62b7e02d4f99b6e63ef2e199943c8b167'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Resource: {
      ...
      readonly bigint: CodecTypes['pg/int8@1']['output'];
    };
  };
};
export type FieldInputTypes = {
  readonly public: {
    readonly Resource: {
      ...
      readonly bigint: CodecTypes['pg/int8@1']['input'];
    };
  };
};
...
export namespace Models {
  export type public_Resource = {
    ...
    bigint: CodecTypes['pg/int8@1']['output'];
        ...
        readonly entries: {
          readonly table: {
            readonly resource: {
              ...
              uniques: readonly [{ readonly columns: readonly ['bigint'] }];
              indexes: readonly [];
